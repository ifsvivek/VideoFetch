        ...
        if player_type == "flowplayer":
            ...
            extra_info_dict = {
                ...
                "release_timestamp": int_or_none(
                    self._html_search_meta(
                        "dtk:publishdateunix", webpage, fatal=False, default=None
                    ),
                    1000,
                ),
                "timestamp": int_or_none(
                    self._html_search_meta(
                        "dtk:createdateunix", webpage, fatal=False, default=None
                    ),
                    1000,
                ),
                "uploader": self._search_regex(
                    r"([^-]+)",
                    self._html_search_meta("dtk:author", webpage, default="").strip(),
                    "uploader",
                    default=None,
                ),
            }
