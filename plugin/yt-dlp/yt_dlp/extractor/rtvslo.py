...
class RTVSLOIE(InfoExtractor):
    ...
    def _real_extract(self, url):
                ...
                formats.append(
                    {
                        **f,
                        ...
                        "language": (
                            "slv"
                            if f.get("language") == "eng" and f.get("acodec") != "none"
                            else f.get("language")
                        ),
                    }
                )
        ...
        for mediafile in traverse_obj(
            media, ("mediaFiles", lambda _, v: url_or_none(v["streams"]["https"]))
        ):
            formats.append(
                traverse_obj(
                    mediafile,
        ...
        for mediafile in traverse_obj(
            media, ("mediaFiles", lambda _, v: url_or_none(v["streams"]["hls_sec"]))
        ):
            formats.extend(
