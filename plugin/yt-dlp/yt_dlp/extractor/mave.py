...
class MaveBaseIE(InfoExtractor):
    ...
    def _create_entry(self, channel_id, channel_meta, episode_meta):
        episode_code = traverse_obj(
            episode_meta, ("code", {int}, {require("episode code")})
        )
        return {
...
class MaveChannelIE(MaveBaseIE):
    ...
    def _entries(self, channel_id, channel_meta, page_num):
        ...
        for ep in traverse_obj(
            page_data, ("episodes", lambda _, v: v["audio"] and v["id"])
        ):
        ...
        return {
            ...
            **traverse_obj(
            ...
            "entries": InAdvancePagedList(
                ...
                math.ceil(channel_meta["episodes_count"] / self._PAGE_SIZE),
                self._PAGE_SIZE,
            ),
        }
