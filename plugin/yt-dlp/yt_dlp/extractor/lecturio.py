...
class LecturioCourseIE(LecturioBaseIE):
    ...
    def _real_extract(self, url):
        ...
        api_path = (
            "courses/" + course_id if course_id else "course/content/" + nt + ".json"
        )
        ...
        for lecture in course.get("lectures", []):
            ...
            if lecture_url:
                ...
                lecture_url = (
                    f"https://app.lecturio.com/#/lecture/c/{course_id}/{lecture_id}"
                )
            entries.append(
                self.url_result(
...
class LecturioDeCourseIE(LecturioBaseIE):
    ...
    def _real_extract(self, url):
        ...
        title = self._search_regex(r"<h1[^>]*>([^<]+)", webpage, "title", default=None)
