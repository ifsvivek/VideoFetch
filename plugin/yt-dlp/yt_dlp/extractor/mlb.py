...
mutation initPlaybackSession(
    ...
    def _perform_login(self, username, password):
        ...
        self._token_expiry = (
            traverse_obj(self._access_token, ({jwt_decode_hs256}, "exp", {int})) or 0
        )
    ...
    def _extract_formats_and_subtitles(self, broadcast, video_id):
        ...
        if not (m3u8_url and token):
            ...
            if (
                errors
            ):  # Only warn when 'blacked out' or 'not entitled'; radio formats may be available
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_from_matches(
            traverse_obj(
                ...
                (
                    "parts",
                    lambda _, v: v["__typename"] == "Video" or v["type"] == "video",
                ),
            ),
