...
class PanoptoIE(PanoptoBaseIE):
        ...
        def _gen_lines():
            for i, line in enumerate(data):
                ...
                if duration:
                    ...
                    end_time = (
                        traverse_obj(data, (i + 1, "Time")) or delivery["Duration"]
                    )
    ...
    def _extract_streams_formats_and_subtitles(self, video_id, streams, **fmt_kwargs):
        ...
        for stream in streams or []:
            ...
            for stream_url in set(
                traverse_obj(stream, (("StreamHttpUrl", "StreamUrl"), {url_or_none}))
            ):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "timestamp": (
                session_start_time - 11640000000 if session_start_time else None
            ),
            ...
            "channel": traverse_obj(
                delivery, "SessionGroupLongName", "SessionGroupShortName", get_all=False
            ),
            "formats": formats,
            "subtitles": subtitles,
        }
...
class PanoptoListIE(PanoptoBaseIE):
    ...
    def _fetch_page(self, base_url, query_params, display_id, page):
        ...
        for result in get_first(response, "Results", default=[]):
            ...
            yield {
                ...
                "url": traverse_obj(result, "ViewerUrl", "EmbedUrl", get_all=False)
    ...
    def _real_extract(self, url):
        ...
        info["entries"] = OnDemandPagedList(
            functools.partial(self._fetch_page, base_url, query_params, display_id),
            self._PAGE_SIZE,
        )
