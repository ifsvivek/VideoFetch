...
class EuroParlWebstreamIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        webpage_nextjs = self._search_nextjs_data(webpage, display_id)["props"][
            "pageProps"
        ]
        ...
        return {
            ...
            "title": traverse_obj(
                webpage_nextjs, (("mediaItem", "title"), ("title",)), get_all=False
            ),
            "formats": formats,
            "subtitles": subtitles,
            "release_timestamp": parse_iso8601(json_info.get("startDateTime")),
            "is_live": traverse_obj(webpage_nextjs, ("mediaItem", "mediaSubType"))
            == "Live",
        }
