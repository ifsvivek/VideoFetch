...
class CallinIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if app_slug and show_slug and "/" in show_slug:
            ...
            show_json_url = (
                f"https://www.callin.com/_next/data/{app_slug}/show/{show_slug}.json"
            )
        ...
        host_nick = (
            host_nick.rsplit("/", 1)[1] if (host_nick and "/" in host_nick) else None
        )
        ...
        cast = list(
            filter(
                ...
                [
                    ...
                    for u in traverse_obj(episode, (("speakers", "callerTags"), ...))
                    or []
                ],
            )
        )
