...
class GoIE(AdobePassIE):
    ...
    _VALID_URL = [
        rf"https?://(?:www\.)?(?P<site>abc)\.com/{_URL_PATH_RE}",
        rf"https?://(?:www\.)?(?P<site>freeform)\.com/{_URL_PATH_RE}",
        rf"https?://(?:www\.)?(?P<site>disneynow)\.com/{_URL_PATH_RE}",
        rf"https?://fxnow\.(?P<site>fxnetworks)\.com/{_URL_PATH_RE}",
        rf"https?://(?:www\.)?(?P<site>nationalgeographic)\.com/tv/{_URL_PATH_RE}",
    ]
    _TESTS = [
        {
        ...
        if not video_id:
            video_id = self._search_regex(
                [
                    ...
                    r'\bvideoIdCode["\']\s*:\s*["\']((?:vdka|VDKA)\d+)',
                ],
                webpage,
                "video ID",
            )
            ...
            if ext == "m3u8":
                ...
                if video_data.get("accesslevel") == "1":
                    ...
                    software_statement = (
                        ...
                        or site_info["software_statement"]
                    )
