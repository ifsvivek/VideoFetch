...
class UlizaPlayerIE(InfoExtractor):
    ...
    _TESTS = [
        {
            ...
            "info_dict": {
                ...
                "_old_archive_ids": [
                    "piaulizaportal 88f3109a-f503-4d0f-a9f7-9f39ac745d84"
                ],
            },
        },
        {
            ...
            "info_dict": {
                ...
                "_old_archive_ids": [
                    "piaulizaportal ae350126-5e22-4a7f-a8ac-8d0fd448b800"
                ],
            },
        },
        {
            ...
            "info_dict": {
                ...
                "live_status": "not_live",
                "_old_archive_ids": [
                    "piaulizaportal 0644ecc8-e354-41b4-b957-3b08a2d63df1"
                ],
            },
        },
    ]
    ...
    def _real_extract(self, url):
        ...
        player_data = self._download_webpage(
            url,
            display_id,
            headers={"Referer": "https://player-api.p.uliza.jp/"},
            note="Fetching player data",
            errnote="Unable to fetch player data",
        )
    ...
    def _real_extract(self, url):
        ...
        if expires and expires <= time_seconds():
            raise ExtractorError(
                "The link is expired", video_id=video_id, expected=True
            )
