...
class TBSIE(TurnerBaseIE):
    ...
    def _real_extract(self, url):
        site, path, display_id, watch = self._match_valid_url(url).group(
            "site", "path", "id", "watch"
        )
        is_live = bool(watch)
        ...
        software_statement = (
            auth_info.get("softwareStatement") or self._SITE_INFO[site][1]
        )
