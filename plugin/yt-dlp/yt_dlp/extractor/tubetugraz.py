                ...
                formats = [
                    {
                        "url": url,
                        "abr": float_or_none(
                            traverse_obj(format_info, ("audio", "bitrate")), 1000
                        ),
                        "vbr": float_or_none(
                            traverse_obj(format_info, ("video", "bitrate")), 1000
                        ),
...
class TubeTuGrazIE(TubeTuGrazBaseIE):
    ...
    def _real_extract(self, url):
        ...
        episode_info = traverse_obj(
            episode_data, ("search-results", "result"), default={"id": video_id}
        )
...
class TubeTuGrazSeriesIE(TubeTuGrazBaseIE):
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_result(
            map(self._extract_episode, episodes_data["search-results"]["result"]),
            playlist_id,
            traverse_obj(
                series_data,
