        ...
        if self._yes_playlist(series_id, video_id, idata):
            ...
            if product:
                ...
                return self.playlist_result(
                    entries, series_id, series.get("name"), series.get("description")
                )
...
class ViuOTTIndonesiaIE(ViuOTTIndonesiaBaseIE):
    ...
    def _real_extract(self, url):
        ...
        initial_state = self._search_json(
            r"window\.__INITIAL_STATE__\s*=", webpage, "initial state", display_id
        )["content"]["clipDetails"]
        ...
        return {
            ...
            "episode_number": (
                traverse_obj(
                    initial_state, "episode_no", "episodeno", expected_type=int_or_none
                )
