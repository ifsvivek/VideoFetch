...
class PeriscopeBaseIE(InfoExtractor):
    ...
    def _extract_pscp_m3u8_formats(
        ...
        m3u8_formats = self._extract_m3u8_formats(
            ...
            video_id,
            "mp4",
            entry_protocol="m3u8_native" if state in ("ended", "timed_out") else "m3u8",
            m3u8_id=format_id,
            fatal=fatal,
...
class PeriscopeUserIE(PeriscopeBaseIE):
    ...
    def _real_extract(self, url):
        ...
        user_id = user["id"]
        session_id = data_store["SessionToken"]["public"]["broadcastHistory"]["token"][
            "session_id"
        ]
        ...
        entries = [
            self.url_result(f"https://www.periscope.tv/{user_name}/{broadcast_id}")
