...
class QQMusicIE(QQMusicBaseIE):
    ...
    def _real_extract(self, url):
        ...
        lrc_content = traverse_obj(
            data,
            ("req_2", "data", "lyric", {lambda x: base64.b64decode(x).decode("utf-8")}),
        )
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_result(
            ...
            playlist_title=join_nonempty(
                *traverse_obj(
                    toplist_json, ((("topinfo", "ListName"), "update_time"), None)
                ),
                delim=" ",
            ),
...
class QQMusicVideoIE(QQMusicBaseIE):
    ...
    def _real_extract(self, url):
        ...
        if (
            traverse_obj(video_info, ("mvInfo", "data", video_id, "play_forbid_reason"))
            == 3
        ):
