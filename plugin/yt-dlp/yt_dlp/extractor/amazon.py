...
class AmazonStoreIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_result(
            entries, playlist_id=playlist_id, playlist_title=data_json.get("title")
        )
...
class AmazonReviewsIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "title": (
                clean_html(
                    get_element_by_attribute("data-hook", "review-title", webpage)
                )
            ...
            "average_rating": float_or_none(
                clean_html(
                    get_element_by_attribute("data-hook", "review-star-rating", webpage)
                    or ""
                ).partition(" ")[0]
            ),
