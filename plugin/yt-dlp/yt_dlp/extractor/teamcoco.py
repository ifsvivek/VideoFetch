...
class TeamcocoIE(TeamcocoBaseIE):
    ...
    def _real_extract(self, url):
        ...
        data = self._search_nextjs_data(webpage, display_id)["props"]["pageProps"][
            "pageData"
        ]
        info = merge_dicts(
            *traverse_obj(
  ...
  findRecordVideoMetadata(id: $id) {
    ...
    def _real_extract(self, url):
        ...
        media_id = traverse_obj(
            response,
            ("data", ("findRecord", "findRecordVideoMetadata"), "turnerMediaId"),
            get_all=False,
        )
        if media_id:
            token = traverse_obj(
            ...
            )  # TODO: the None arg needs to be the AdobePass software_statement
        else:
