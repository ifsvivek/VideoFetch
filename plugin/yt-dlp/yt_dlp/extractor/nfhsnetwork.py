...
class NFHSNetworkIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        data = self._download_json(
            "https://cfunity.nfhsnetwork.com/v2/game_or_event/" + video_id, video_id
        )
        ...
        is_live = (
            broadcast.get("on_air") or broadcast.get("status") == "on_air" or False
        )
        ...
        m3u8_url = self._download_json(
            f"https://cfunity.nfhsnetwork.com/v2/{video_type}/{key}/url", video_id
        ).get("video_url")
