...
class AdobeTVVideoIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        for source in traverse_obj(
            ...
            (
                "sources",
                lambda _, v: v["format"] != "playlist" and url_or_none(v["src"]),
            ),
        ):
        ...
        subtitles = {}
        for translation in traverse_obj(
            video_data,
            (
                "translations",
                lambda _, v: url_or_none(v["vttPath"]),
            ),
        ):
            lang = (
                translation.get("language_w3c")
                or ISO639Utils.long2short(translation.get("language_medium"))
                or "und"
            )
