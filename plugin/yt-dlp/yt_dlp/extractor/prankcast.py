...
class PrankCastIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        json_info = self._search_nextjs_data(webpage, video_id)["props"]["pageProps"][
            "ssr_data_showreel"
        ]
        ...
        return {
            ...
            "cast": list(
                filter(None, [uploader, *traverse_obj(guests_json, (..., "name"))])
            ),
...
class PrankCastPostIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        webpage = self._download_webpage(url, video_id)
        post = self._search_nextjs_data(webpage, video_id)["props"]["pageProps"][
            "ssr_data_posts"
        ]
